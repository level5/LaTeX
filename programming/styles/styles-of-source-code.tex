...
% environment for command line
\lstdefinelanguage{Command-Line}{
}
\lstnewenvironment{Command-Line}[1][]
{\lstset{language=Command-Line,
  showspaces=false,
  showtabs=false,
  breaklines=true,
